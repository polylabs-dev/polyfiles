# Q Files — GitHub Issues

> **GitHub org**: [polylabs-dev](https://github.com/polylabs-dev) | **Repo**: [polylabs-dev/qfiles](https://github.com/polylabs-dev/qfiles)
> **Architecture**: [ARCHITECTURE.md](../../docs/ARCHITECTURE.md)
> **Note**: poly-git issues (#023-#028) have been migrated to the [Q Git repo](../../../qgit/.github/issues/README.md).

## Epic 01: Phase 1 — Core Storage (Q2 2026) — [#1](https://github.com/polylabs-dev/qfiles/issues/1)

| # | Issue | Status | Priority |
|---|-------|--------|----------|
| 001 | Scaffold FLIR client circuits (`q-data-encrypt`, `q-data-chunk`, `q-data-classify`, `q-data-manifest`) | Open | P0 |
| 002 | SPARK identity integration (`q-data-v1` HKDF context, wire auth 0x50-0x54) | Open | P0 |
...
| 008 | `q-data-storage-router` server circuit (scatter 3-of-5) | Open | P0 |
| 009 | ESLite client-side state (`/qfiles/files/*`, `/qfiles/index/*`, `/qfiles/offline/*`) | Open | P0 |
...
| 013 | `q-data-metering` server circuit (8-dimension) | Open | P1 |

## Epic 02: Phase 2 — Collaboration (Q3 2026) — [#2](https://github.com/polylabs-dev/qfiles/issues/2)

| # | Issue | Status | Priority |
|---|-------|--------|----------|
| 014 | ACL-based sharing via SPARK DIDs on streams (`q-data-share` circuit) | Open | P0 |
| 015 | Ephemeral link file sharing (upstream: [estream-io #552](https://github.com/polyquantum/estream-io/issues/552)) | Open | P0 |
| 016 | `q-data-version` server circuit (hash chain, manifest storage) | Open | P0 |
...
| 021 | ESLM auto-classification circuit (`q-data-eslm-classify`) | Open | P0 |
| 022 | `.polyclassification` file support | Open | P1 |

## Epic 03: Phase 3 — Enterprise (Q1 2027) — [#4](https://github.com/polylabs-dev/qfiles/issues/4)

> poly-git issues (#023-#028) migrated to [qgit/.github/issues/README.md](../../../qgit/.github/issues/README.md)
...
| 031 | SOVEREIGN classification with HSM (Q Vault) | Open | P2 |
...
## Epic 04: Console Widgets — [#5](https://github.com/polylabs-dev/qfiles/issues/5)
...
| 041 | RBAC: `qfiles-operator`, `qfiles-viewer`, `qfiles-compliance` roles | Open | P1 |
